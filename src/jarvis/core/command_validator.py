...
def validate_command(command: str, strict: bool = False) -> ValidationResult:
    """
    Convenience function to validate a command.
    
    Args:
        command: The command to validate
        strict: If True, applies stricter validation
        
    Returns:
        ValidationResult
    """
    return validator.validate(command, strict=strict)
